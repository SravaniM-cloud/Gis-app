...
(function (factory) {
    ...
    L.Control.PolylineMeasure = L.Control.extend({
        ...
        _toggleMeasure: function () {
            ...
            if (this._measuring && this.lastDrawn) {   // if measuring is going to be switched on
        ...
        _finishPolylinePath: function (e) {
            this._map.fire('polylinemeasure:finish', this._layerPaint);
