L.Control.ZoomBar = L.Control.extend({
  ...
  options: {
    ...
    zoomInIconClass: 'icon mdi mdi-plus',
    zoomOutIconClass: 'icon mdi mdi-minus',
    zoomToBBoxIconClass: 'icon mdi mdi-loupe',
    addFullScreen: true,
    fullscreenIconClass: 'icon mdi mdi-fullscreen',
    showHistoryControl: true,
    backViewIconClass: 'icon mdi mdi-chevron-left move',
    forwardViewIconClass: 'icon mdi mdi-chevron-right move'
  },
...
L.Control.HistoryControl = L.Control.extend({
  ...
  options: {
    ...
    backImage: 'mdi mdi-chevron-left',
    backText: '',
    backTooltip: 'Go to Previous Extent',
    backImageBeforeText: true,
    forwardImage: 'mdi mdi-chevron-right',
    forwardText: '',
